...
**AI amplifies engineers. It does not replace engineering.** And engineering is a craft that must be grown — not just deployed.
...
Read [the framework](framework.md) for how these beliefs translate into day-to-day behaviour.
