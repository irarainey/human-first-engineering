...
- [Templates & Prompts](templates/index.md) — an `AGENTS.md` template for tools
  that support it, native examples for GitHub Copilot and Claude Code, plus
  reusable prompts for framing problems, reviewing AI-assisted code, and
  assessing risk.
