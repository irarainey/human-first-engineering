...
Copy the prompt below into your AI assistant, replacing `<TASK DESCRIPTION>` with your task. The output is a short frame you can paste into a PR description, share with a reviewer, or hand back to the AI as context for the actual implementation.
