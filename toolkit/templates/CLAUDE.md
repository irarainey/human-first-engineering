...
<!--
  Human-First Engineering — Claude instruction file template.

  Save this file as `CLAUDE.md` at the root of your repository.
  Claude Code and the Claude API will read it as project context.
